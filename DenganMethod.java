public class DenganMethod {
    ...
    public static int hitungTotalPenghasilan(int gajiPokok, int tunjangaTransport, int tunjanganMakan, int bonus) {
        return gajiPokok + tunjangaTransport + tunjanganMakan + bonus;
    }

    public static int hitungPajak(int totalPengasilan) {
        return totalPengasilan * 10 / 100;
    }
